...
[![build status](https://github.com/gvatsal60/portfolio/actions/workflows/readme-checker.yaml/badge.svg)](https://github.com/gvatsal60/portfolio/actions/workflows/readme-checker.yaml)
...
1. **Clone the repository:**
   ...
   ```bash
   git clone https://github.com/gvatsal60/portfolio.git
   cd portfolio
   ```
...
[LICENSE](https://github.com/gvatsal60/portfolio/blob/HEAD/LICENSE) file for details.
